...
import { FiltersUsers, UserrepositoryDomain } from "../../../../domain/repositories/userRepository.domain";
    ...
    async save(user: UserEntity): Promise<void> {
        ...
        const persistenceData = {
            ...
            verificationToken: data.verificationToken
                ? {
                    token: data.verificationToken.value,
                    expiresAt: data.verificationToken.expiresAt,
                }
                : null,
            passwordResetToken: data.passwordResetToken
                ? {
                    token: data.passwordResetToken.value,
                    expiresAt: data.passwordResetToken.expiresAt,
                }
                : null,
